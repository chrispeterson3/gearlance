...
items = [
  ...
  { category_id: Category.find_by_name("Lens").id, name: "Zoidberg", photo_url: "http://images2.fanpop.com/images/photos/3100000/Zoidberg-futurama-3153999-1024-768.jpg", description: "This is NOT a piece of equipment.", daily_price: 10, weekly_price: 40, monthly_price: 100, user_id: 1 }
]
